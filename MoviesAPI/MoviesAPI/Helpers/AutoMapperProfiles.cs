    ...
    public class AutoMapperProfiles: Profile
    {
        public AutoMapperProfiles(GeometryFactory geometryFactory)
        {
            ...
            CreateMap<Movie, MovieDTO>()
                ...
                .ForMember(x => x.MovieTheaters, options => options.MapFrom(MapMoviesTheatersMovies))
        ...
        private List<MovieTheaterDTO> MapMoviesTheatersMovies(Movie movie, MovieDTO movieDTO)
        {
